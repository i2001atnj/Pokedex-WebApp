  ...
  return (
    <div className='PokemonPage' style={{background: `${themeColor}`}}>
      ...
      <div className='PokemonPage-ImageSection'>
        <button id='ChevronLeft' onClick={prevPage}><img src={ ChevronLeftVector } alt=""/></button>
        <div className='Silouette'>
          <img src={ pokemon.sprites.other["official-artwork"].front_default } alt=""/>
        </div>
        <button id='ChevronRight' onClick={nextPage}><img src={ ChevronRightVector } alt=""/></button>
      </div>
      <div className='PokemonPage-CardSection'>
        <div className='Types'>
        {pokemon.types.map(pokemon => (
          <div className='Type' style={{background: `${typeColor[pokemon.type.name]}`}}>
        ...
        <p id='PokemonInfo'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. At ab similique hic numquam explicabo cupiditate harum non, deleniti a placeat, corrupti veniam aliquam quibusdam assumenda rem distinctio nemo id debitis?</p>
